...
const AddNews = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await Swal.fire({
      title: "Simpan Data?",
      text: "Apakah Anda yakin ingin menyimpan data Berita ini?",
      icon: "warning",
    ...
    if (result.isConfirmed) {
      try {
        ...
        const response = await axiosInstance.post("/news/upload", data, {
          headers: {
        ...
        if (response.status === 201){
          Swal.fire("Data Berita telah disimpan!", "", "success");
    ...
    <div>
        <label className="block text-sm font-semibold text-gray-600 mb-2">
            ...
            <option value="" disabled>
                ...
                <option value="Geoarkeologi">Satuan Kerja</option>
                <option value="Sosiokultural">Penugasan</option>
                <option value="Situs budaya">Keriminal</option>
            </select>
    </div>
